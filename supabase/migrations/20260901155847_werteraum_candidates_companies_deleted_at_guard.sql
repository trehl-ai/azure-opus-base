-- 01.09.2026: get_werteraum_candidates jointe companies OHNE deleted_at-Pruefung.
-- Folge: eine archivierte Schule haette weiterhin Kampagnenmails bekommen, ohne
-- Fehler und ohne roten Lauf. Vorbedingung fuer den Archivieren-Knopf in der
-- Firmenliste. Zum Zeitpunkt der Anwendung ein No-op: 239 Kandidaten vorher wie
-- nachher, weil noch keine Firma mit WerteRaum-Deal archiviert war.
