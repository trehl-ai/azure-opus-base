-- Exclude data-cleanup lost markers from the KW widget's "Als verloren markiert"
-- row. Backfill landed 2026-05-28: 23 deals carry lost_reason='Ersetzt durch
-- Einzeldeals (Import 28.05.2026)', and the new filter pattern is generic on
-- any future "Import" cleanup tag too.
...
BEGIN
  RETURN json_build_object(
    ...
    -- Als verloren markiert: lost_reason ILIKE '%Import%' wird ausgeschlossen,
    -- damit Datenbereinigungen nicht als Sales-Verlust gezählt werden.
    'lost_diese_kw', (
