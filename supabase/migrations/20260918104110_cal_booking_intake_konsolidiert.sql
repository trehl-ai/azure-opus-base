-- 18.09.2026: Konsolidierung — cal_booking_intake schreibt schulfelder_alle in die Metadaten.
--
-- ⚠ DRIFT-BEFUND (der dritte dieser Art in zwei Tagen): Die Migration
-- 20260917165936 hat cal_schule_aus_responses um schulfelder_alle erweitert,
-- der Aufrufer cal_booking_intake nahm aber weiter nur die Einzelfelder. Der
-- Fix im Intake lief am 18.09. als DO-Block — ein DO-Block hinterlaesst keine
-- Version. Gemessen am 18.09. mit der Testbuchung 4XDQPqEP: formular_schule
-- war gefuellt, schulfelder_alle fehlte.
--
-- Diese Migration schreibt den LIVE-STAND der Funktion 1:1 fest
-- (pg_get_functiondef, md5 vorher 86e56292…). Sie aendert am Laufzeitverhalten
  ...
  BEGIN
    ...
    VALUES (
      ...
      jsonb_build_object('cal_uid',v_uid,'trigger',v_trigger,
                         ...
                         -- Alle Schulfelder, nicht nur der Gewinner: Armins
                         -- Event hat zwei, und wenn sie auseinandergehen,
                         -- soll das sichtbar sein statt still zu verschwinden.
                         'schulfelder_alle',v_formular->'schulfelder_alle',
