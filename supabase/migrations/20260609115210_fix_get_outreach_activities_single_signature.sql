-- Migration: 20260609115210_fix_get_outreach_activities_single_signature
...
-- Alte Signaturen droppen und sauber neu anlegen
DROP FUNCTION IF EXISTS get_outreach_activities(integer);
DROP FUNCTION IF EXISTS get_outreach_activities(integer, uuid);
