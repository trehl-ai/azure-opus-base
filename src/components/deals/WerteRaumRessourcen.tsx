...
// Google Docs Viewer — embedded=true for the inline hover iframe, false for the
// full-tab view. Mirrors the pattern in ProjectResources.openLeitfaden.
  ...
  return (
    <div className="rounded-2xl border border-border bg-card p-6 space-y-4">
      ...
      <div className="flex items-center gap-2">
        ...
        <h3 className="text-label font-semibold text-foreground">WerteRaum Ressourcen</h3>
      </div>
        ...
        {ROWS.map((row) => {
          ...
          return (
            ...
            >
              ...
              {/* Hover preview — floats to the LEFT of the row so it stays on-screen */}
              {showPreview && path && (
                <div
